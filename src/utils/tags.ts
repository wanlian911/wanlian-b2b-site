...
export const tags: Tag[] = [
  ...
  },
  {
    ...
    guideHrefs: ['/guides/how-to-choose-ul-listed-fire-valves/', '/guides/b2b-valve-sourcing-checklist/'],
    productSlugs: [],
