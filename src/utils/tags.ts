...
export const tags: Tag[] = [
  {
    ...
    seoTitle: 'Fire Protection Equipment & Systems: Valves, Hydrants & Sprinklers',
  ...
  },
  {
    ...
    guideHrefs: ['/guides/how-to-choose-a-fire-hydrant/', '/guides/wanlian-fluid-vs-american-avk/', '/guides/fire-hydrant-valve-standards-guide/', '/guides/antifreeze-anti-collision-fire-hydrant-guide/', '/guides/municipal-water-fire-infrastructure-latinamerica/', '/guides/wanlian-fluid-vs-avk-latinamerica/', '/guides/municipal-fire-water-main-upgrade-guide/', '/guides/wanlian-fluid-vs-mueller/'],
  ...
  },
  {
    ...
    seoTitle: 'Fire Sprinkler Systems: Wet, Deluge & Pre-action Valves',
    ...
    guideHrefs: ['/guides/fire-sprinkler-system-valves-guide/', '/guides/fire-sprinkler-system-wet-dry-preaction/', '/guides/fire-sprinkler-control-valve-types/', '/guides/fire-sprinkler-head-selection-guide/', '/guides/commercial-building-sprinkler-system-bom-guide/'],
  ...
  },
  {
    ...
    seoTitle: 'Backflow Preventers & Hydraulic Control Valves',
    ...
    guideHrefs: ['/guides/backflow-prevention-guide/', '/guides/pressure-reducing-valve-guide/', '/guides/hvac-digital-balancing-valve-guide/'],
  ...
  },
  {
    ...
    guideHrefs: ['/guides/gate-valve-vs-butterfly-valve-fire-protection/', '/guides/b2b-valve-sourcing-checklist/', '/guides/how-to-choose-ul-listed-fire-valves/', '/guides/bellows-seal-gate-valve-guide/', '/guides/check-valve-types-guide/', '/guides/wanlian-fluid-vs-american-avk/', '/guides/wanlian-fluid-vs-avk-latinamerica/', '/guides/hvac-digital-balancing-valve-guide/', '/guides/municipal-fire-water-main-upgrade-guide/', '/guides/wanlian-fluid-vs-tupy/', '/guides/wanlian-fluid-vs-mueller/'],
  ...
  },
  {
    ...
    seoTitle: 'Fire Hose Reels & Fire Cabinets: Selection Guide',
  ...
  },
  {
    ...
    guideHrefs: ['/guides/how-to-choose-ul-listed-fire-valves/', '/guides/b2b-valve-sourcing-checklist/', '/guides/ce-en12845-fire-protection-compliance/', '/guides/how-to-verify-chinese-valve-supplier/', '/guides/latinamerica-certification-requirements-fire-valves/', '/guides/detect-fake-valves-fire-equipment-counterfeits/', '/guides/cross-border-procurement-risk-whitepaper/'],
    productSlugs: [],
  ...
  },
  {
    ...
    guideHrefs: ['/guides/b2b-valve-sourcing-checklist/', '/guides/how-to-choose-a-fire-hydrant/', '/guides/wanlian-fluid-vs-american-avk/', '/guides/how-to-verify-chinese-valve-supplier/', '/guides/fire-hydrant-valve-standards-guide/', '/guides/municipal-water-fire-infrastructure-latinamerica/', '/guides/latinamerica-certification-requirements-fire-valves/', '/guides/detect-fake-valves-fire-equipment-counterfeits/', '/guides/wanlian-fluid-vs-avk-latinamerica/', '/guides/wanlian-fluid-vs-ca-fire/', '/guides/wanlian-fluid-vs-forede/', '/guides/wanlian-fluid-vs-zhiyuan/', '/guides/cross-border-procurement-risk-whitepaper/', '/guides/commercial-building-sprinkler-system-bom-guide/', '/guides/municipal-fire-water-main-upgrade-guide/', '/guides/wanlian-fluid-vs-tupy/', '/guides/wanlian-fluid-vs-mueller/', '/guides/fire-protection-market-data-report-2026/'],
    productSlugs: [],
  ...
  },
  {
    ...
    seoTitle: 'Bellows Seal Gate Valves for Steam & Thermal Oil',
