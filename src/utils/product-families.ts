...
export const PRODUCT_FAMILIES = [
  ...
  { id: "hydrants", label: "Fire Hydrants", slugs: ["anti-collision-pressure-regulating-outdoor-hydrant-ssft100", "foam-fire-hydrant-cabinet-psg30", "indoor-fire-hydrant-head-sn65", "iot-smart-ground-fire-hydrant-ss100zn", "overground-fire-hydrant-ss100"] },
  ...
  { id: "sprinkler-system", label: "Sprinkler Systems", slugs: ["deluge-alarm-valve-zsfm", "glass-bulb-fire-sprinkler-zst", "horizontal-sidewall-fire-sprinkler-t-zstbs", "pre-action-alarm-system-zsfy", "water-flow-indicator-zsjz", "wet-alarm-check-valve-zsfz-150", "zstdy-concealed-fire-sprinkler"] },
...
export const PRODUCT_FAMILY_RELATED: Record<string, string[]> = {
  ...
  "adjustable-pressure-reducing-valve-500x": ["hydraulic-water-level-control-valve-f745x", "remote-control-float-valve-100x", "telescopic-y-strainer-sgl41h", "smart-electromagnetic-flow-meter"],
  "anti-collision-pressure-regulating-outdoor-hydrant-ssft100": ["overground-fire-hydrant-ss100", "iot-smart-ground-fire-hydrant-ss100zn", "indoor-fire-hydrant-head-sn65", "foam-fire-hydrant-cabinet-psg30"],
  ...
  "deluge-alarm-valve-zsfm": ["glass-bulb-fire-sprinkler-zst", "horizontal-sidewall-fire-sprinkler-t-zstbs", "zstdy-concealed-fire-sprinkler", "pre-action-alarm-system-zsfy"],
  ...
  "foam-fire-hydrant-cabinet-psg30": ["overground-fire-hydrant-ss100", "iot-smart-ground-fire-hydrant-ss100zn", "anti-collision-pressure-regulating-outdoor-hydrant-ssft100", "indoor-fire-hydrant-head-sn65"],
  "glass-bulb-fire-sprinkler-zst": ["horizontal-sidewall-fire-sprinkler-t-zstbs", "zstdy-concealed-fire-sprinkler", "deluge-alarm-valve-zsfm", "pre-action-alarm-system-zsfy"],
  ...
  "horizontal-sidewall-fire-sprinkler-t-zstbs": ["glass-bulb-fire-sprinkler-zst", "zstdy-concealed-fire-sprinkler", "deluge-alarm-valve-zsfm", "pre-action-alarm-system-zsfy"],
  "hydraulic-water-level-control-valve-f745x": ["adjustable-pressure-reducing-valve-500x", "remote-control-float-valve-100x", "telescopic-y-strainer-sgl41h", "smart-electromagnetic-flow-meter"],
  "indoor-fire-hydrant-head-sn65": ["overground-fire-hydrant-ss100", "iot-smart-ground-fire-hydrant-ss100zn", "anti-collision-pressure-regulating-outdoor-hydrant-ssft100", "foam-fire-hydrant-cabinet-psg30"],
  "iot-smart-ground-fire-hydrant-ss100zn": ["overground-fire-hydrant-ss100", "anti-collision-pressure-regulating-outdoor-hydrant-ssft100", "indoor-fire-hydrant-head-sn65", "foam-fire-hydrant-cabinet-psg30"],
  ...
  "overground-fire-hydrant-ss100": ["iot-smart-ground-fire-hydrant-ss100zn", "anti-collision-pressure-regulating-outdoor-hydrant-ssft100", "indoor-fire-hydrant-head-sn65", "foam-fire-hydrant-cabinet-psg30"],
  "pre-action-alarm-system-zsfy": ["glass-bulb-fire-sprinkler-zst", "horizontal-sidewall-fire-sprinkler-t-zstbs", "zstdy-concealed-fire-sprinkler", "deluge-alarm-valve-zsfm"],
  "remote-control-float-valve-100x": ["adjustable-pressure-reducing-valve-500x", "hydraulic-water-level-control-valve-f745x", "telescopic-y-strainer-sgl41h", "smart-electromagnetic-flow-meter"],
  ...
  "smart-electromagnetic-flow-meter": ["adjustable-pressure-reducing-valve-500x", "hydraulic-water-level-control-valve-f745x", "remote-control-float-valve-100x", "telescopic-y-strainer-sgl41h"],
  ...
  "telescopic-y-strainer-sgl41h": ["adjustable-pressure-reducing-valve-500x", "hydraulic-water-level-control-valve-f745x", "remote-control-float-valve-100x", "smart-electromagnetic-flow-meter"],
  ...
  "water-flow-indicator-zsjz": ["glass-bulb-fire-sprinkler-zst", "horizontal-sidewall-fire-sprinkler-t-zstbs", "zstdy-concealed-fire-sprinkler", "deluge-alarm-valve-zsfm"],
  "wet-alarm-check-valve-zsfz-150": ["glass-bulb-fire-sprinkler-zst", "horizontal-sidewall-fire-sprinkler-t-zstbs", "zstdy-concealed-fire-sprinkler", "deluge-alarm-valve-zsfm"],
  ...
  "zstdy-concealed-fire-sprinkler": ["glass-bulb-fire-sprinkler-zst", "horizontal-sidewall-fire-sprinkler-t-zstbs", "deluge-alarm-valve-zsfm", "pre-action-alarm-system-zsfy"],
};
