...
export const guidesAr: GuideAr[] = [
  {
    ...
    tocPreview: ["لماذا يُهمّ منع الارتداد","فئات الخطورة وأنواع الأجهزة","كيف يعمل تجميع الرجوع المزدوج HS41X"],
    date: '2026-08',
  ...
  },
  {
    ...
    tocPreview: ["دور بكرات مرن والخزائن","بكرة مرن مقابل خزانة حريق: التعريفات","طول المرن وقطره وضغطه"],
    date: '2026-08',
  ...
  },
  {
    ...
    tocPreview: ["المنظورات اليدوية (سلسلة PS): تحكم المشغل","المنظورات ذاتية التتبع (ZDMS): استجابة مستقلة","مقارنة مباشرة"],
    date: '2026',
    category: 'حماية الحريق',
  ...
  },
  {
    ...
    tocPreview: ["1. أنظمة الأنابيب الرطبة: صمام الإنذار الرطب ZSFZ","2. أنظمة الرش الشامل: صمام الرش الشامل ZSFM","3. أنظمة الفعل المسبق: صمام التشغيل المزدوج ZSFY"],
    date: '2026',
    category: 'حماية الحريق',
    readTime: '7 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["قائمة التحقق الثمانية","ملخص العلامات التحذيرية","كيف تطلب عرض سعر موثّق"],
    date: '2026',
    category: 'توريد',
    readTime: '6 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["1. ما يعنيه اعتماد UL لصمامات الحريق","2. أنواع صمامات الحريق التي ستخصصها فعليًا","3. مواصفات رئيسية للمقارنة"],
    date: '2026',
    category: 'حماية الحريق',
    readTime: '7 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["1. هل تحتاج فعلًا إلى مدفع مياه؟","2. ثابت، تحكم عن بُعد، أو تتبّع آلي؟","3. حساب التدفق والمدى"],
    date: '2026',
    category: 'حماية الحريق',
    readTime: '6 دقائق قراءة',
    tags: ['fire-water-cannon', 'fire-protection']
  },
  {
    ...
    tocPreview: ["أنواع الأنظمة الثلاثة مقارنةً","اختيار رؤوس الرش","المكونات التي يحتاجها BOM"],
    date: '2026',
    category: 'حماية الحريق',
    readTime: '7 دقائق قراءة',
    tags: ['sprinkler-systems', 'fire-protection']
  },
  {
    ...
    tocPreview: ["افهم متطلب خلاطك أولًا","أنواع خلاطات الحريق موضحة","المواصفات الرئيسية للمقارنة"],
    date: '2026',
    category: 'حماية الحريق',
    readTime: '8 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["كيف تعمل: مقارنة سريعة","بوابة مقابل فراشة: مقارنة مباشرة","مكان كل صمام في أنظمة الحماية من الحريق"],
    date: '2026',
    category: 'صمامات',
    readTime: '7 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["دور صمامات التحكم في رش الحريق","صمامات البوابة OS&Y: عزل رئيسي مُراقب","صمامات الفراشة بالإشارة لتحكم المقاطع"],
    date: '2026-09',
    category: 'حماية الحريق',
    readTime: '8 دقائق قراءة',
    tags: ['sprinkler-systems', 'fire-protection']
  },
  {
    ...
    tocPreview: ["ما هو صمام البوابة بحجاب محكم؟","كيف يعمل الإحكام المزدوج","أين تُخصص صمامات الحجاب"],
    date: '2026-09',
    category: 'صمامات',
    readTime: '7 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["ما هو صمام خفض الضغط الهيدروليكي؟","كيف يعمل صمام 500X الذاتي","خفض الضغط مقابل التحكم بالمستوى مقابل الطافية"],
    date: '2026-09',
    category: 'السلامة الهيدروليكية',
    readTime: '8 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["ما هو صمام الرجوع؟","أنواع صمامات الرجوع في لمحة","الكرة المنزلقة مقابل الرجوع المتذبذب"],
    date: '2026-09',
    category: 'صمامات',
    readTime: '8 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["1. لماذا تتصدّر طفايات الحريق توريد الحماية من الحريق","2. فئات الحريق ووسائط الإطفاء","3. شرح مواصفات البودرة الجافة ABC"],
    date: '2026-09',
    category: 'حماية الحريق',
    readTime: '8 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["1. الخرطوم المسطع مقابل بكرة خرطوم الحريق","2. تصنيع الخراطيم: الغلاف والبطانة وإحكام الحواف","3. تحديد المقاس: القطر والطول والتطبيقات"],
    date: '2026-09',
    category: 'حماية الحريق',
    readTime: '8 دقائق قراءة',
    tags: ['fire-protection', 'procurement']
  },
  {
    ...
    tocPreview: ["American AVK: من هم فعليًا","Wanlian Fluid: من هم فعليًا","كيف تقارن خطوط المنتجات؟"],
    date: '2026-09',
    category: 'توريد',
  ...
  },
  {
    ...
    tocPreview: ["1. تحقق من الشركة، لا من الكتيّب","2. مطابقة المنتج مع معيار أمر الشراء","3. افرض اختبارًا لكل وحدة وفحصًا من طرف ثالث"],
    date: '2026-09',
    category: 'توريد',
    readTime: '7 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["عائلات المعايير الخمس التي ستقابلها فعليًا","كيف تقرأ معيارًا مقابل تقرير اختبار","ما تعنيه تصنيفات وفئات الضغط عمليًا"],
    date: '2026-09',
    category: 'حماية الحريق',
    readTime: '8 دقائق قراءة',
    tags: ['fire-protection', 'procurement']
  },
  {
    ...
    tocPreview: ["لماذا يُهمّ الامتثال الأوروبي لمعدات الحريق","أساسيات علامة CE: على مستوى الموديل لا السلسلة","EN 12845 وحزمة سحب مضخة الحريق"],
    date: '2026-09',
    category: 'حماية الحريق',
    readTime: '8 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["1. ابدأ من نوع النظام ثم الرأس","2. معامل K والتدفق: مطابقة إمداد الماء","3. تصنيفات الحرارة وترميز ألوان الكبسولة"],
    date: '2026-09',
    category: 'حماية الحريق',
    readTime: '8 دقائق قراءة',
    tags: ['sprinkler-systems', 'fire-protection']
  },
  {
    ...
    tocPreview: ["1. ما هو الصمام بمسار؟","2. بمسار مقابل بفلنجة مقابل مسنّن","3. عائلة صمامات الحريق بمسار"],
    date: '2026-09',
    category: 'حماية الحريق',
    readTime: '8 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["لماذا تفشل الخلاطات في الطقس البارد","كيف تعمل الخلاطات المقاومة للتجمد (البرميل الجاف)","كيف تُغلق الخلاطات المضادة للاصطدام"],
    date: '2026-09',
    category: 'حماية الحريق',
    readTime: '8 دقائق قراءة',
    tags: ['fire-hydrant', 'fire-protection']
  },
  {
    ...
    tocPreview: ["1. ما هو اتصال هيئة الإطفاء؟","2. مدخلان ومخرج واحد","3. معايير موصلات المداخل والموصّلات"],
    date: '2026-09',
    category: 'حماية الحريق',
    readTime: '8 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["1. لماذا تتركّز المقلّدات في هذه الفئة","2. الأشكال الشائعة للمنتجات المقلّدة","3. قائمة كشف من سبعة خطوات"],
    date: '2026-09',
    category: 'توريد B2B',
    readTime: '8 دقائق قراءة',
    tags: ['procurement', 'certification']
  },
  {
    ...
    tocPreview: ["1. ما يتضمنه نطاق مياه وحريق بلدي فعليًا","2. أنظمة المعايير في المنطقة: ما قد يطلبه العطاء","3. كيف يخفض أمر شراء واحد مخاطر التنسيق"],
    date: '2026-09',
    category: 'توريد',
    readTime: '8 دقائق قراءة',
    tags: ['procurement', 'fire-hydrant', 'industrial-valves']
  },
  {
    ...
    tocPreview: ["1. مشهد الاعتمادات لمشاريع الحريق في أمريكا اللاتينية","2. الاعتماد بالتفصيل: ما هو وكيف تتحقق منه","3. على مستوى النموذج مقابل على مستوى المصنع: التمييز الذي يهم"],
    date: '2026-09',
    category: 'توريد',
    readTime: '8 دقائق قراءة',
  ...
  },
  {
    ...
    tocPreview: ["AVK Latinoamérica: من هي فعليًا","Wanlian Fluid: من هي فعليًا","مقارنة جنبًا إلى جنب"],
    date: '2026-09',
    category: 'توريد',
    readTime: '9 دقائق قراءة',
    tags: ['procurement', 'fire-hydrant', 'industrial-valves']
  },
  {
    ...
    tocPreview: ["1. ما هو صمام موازنة HVAC؟","2. كيف يعمل صمام SP45F الرقمي","3. صمام الموازنة مقابل صمام خفض الضغط"],
    date: '2026-09',
